...
def custom_request_next_slot(
    ...
    print('custom_request_next_slot requested slot')
...
class PayCCForm(FormAction):
    ...
    def request_next_slot(
        ...
        print('request next_slot called')
    ...
    def slot_mappings(self) -> Dict[Text, Union[Dict, List[Dict]]]:
        ...
        print('slot mapping')
        print(self.from_entity(entity="payment_amount"),
    ...
    def validate_payment_amount(
        ...
        print('validate_apyment_amount called')
    ...
    def validate_credit_card(
        ...
        print('validate credit_card called')
        cc_balance = tracker.get_slot("credit_card_balance")
